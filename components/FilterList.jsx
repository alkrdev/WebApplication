...
const sortOptions = [
  { name: 'Mest Populær', href: '#', current: false },
...
const filters = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'fountain', label: 'Fontæne', checked: false },
...
export default function FilterList(props) {
    ...
    const filterChange = (e) => {
        var optionType = e.target.id.split("-")[1]
        var temp = { ...filtersApplied }

        if (temp[optionType].includes(e.target.value)) {
            temp[optionType] = temp[optionType].filter(el => el != e.target.value)
        } else {
            temp[optionType].push(e.target.value)
        }
